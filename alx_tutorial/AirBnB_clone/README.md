...
OOP
 By: Guillaume
 Weight: 5
 Project to be done in teams of 2 people (your team: Emebet Worku, Nathan Assefa Kasa)
 Project over - took place from Feb 6, 2023 6:00 AM to Feb 13, 2023 6:00 AM
 Manual QA review was done by Mahlet Seifu Feleke on Feb 13, 2023 8:21 PM
 An auto review will be launched at the deadline
In a nutshell…
Contribution: 100.0%
Manual QA review: 46.0/48 mandatory
Auto QA review: 292.8/302 mandatory & 233.0/233 optional
Altogether:  193.6%
Mandatory: 96.8%
Optional: 100.0%
Contribution: 100.0%
Calculation:  100.0% * (96.8% + (96.8% * 100.0%) )  == 193.6%
Concepts
...
Play Video
HBNB project overview of each part
...
Play Video
Usage of UUID in Python

Python: Unittests
Play Video
How to create and design Python Unittests

Python: BaseModel and inheritance
Play Video
Python class, base model and inheritance in the AirBnB clone project

Code consistency
Play Video
Git usage and code consistency for better team work

Python: Modules and Packages
Play Video
Creation and usage of Python modules and packages
...
0. README, AUTHORS
mandatory
Score: 95.83% (Checks completed: 95.83%)
Write a README.md:
...
2. Unittests
mandatory
Score: 80.77% (Checks completed: 80.77%)
